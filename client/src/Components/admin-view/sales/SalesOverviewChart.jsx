...
const SalesOverviewChart = () => {
	...
	return (
		<motion.div
			className='bg-[#f7d6d0] bg-opacity-50 backdrop-blur-md shadow-lg rounded-xl p-6 border border-gray-700 mb-8'
			...
			<div className='w-full h-80'>
				<ResponsiveContainer>
					<AreaChart data={monthlySalesData}>
						...
						/>
						<Area type='monotone' dataKey='sales' stroke='rgba(40, 20, 100, 0.8)' fill=' rgba(40, 20, 100, 0.6)'/>
					</AreaChart>
				</ResponsiveContainer>
			</div>
		</motion.div>
