...
const ProductPerformance = () => {
	return (
		...
		>
			<h2 className='text-xl font-semibold text-black-100 mb-4'>Product Performance</h2>
			<div style={{ width: "100%", height: 300 }}>
				<ResponsiveContainer>
					<BarChart data={productPerformanceData}>
						...
						/>
						<Legend />
						<Bar dataKey='sales' fill="rgba(40, 20, 100, 0.3)" />
						<Bar dataKey='revenue' fill="rgba(30, 15, 80, 0.6)" />
						<Bar dataKey='profit' fill="rgba(15, 8, 50, 0.8)"/>
					</BarChart>
				</ResponsiveContainer>
			</div>
		</motion.div>
