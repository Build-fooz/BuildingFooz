...
import "./CustomersFav.css"; // Create this file for custom styles
...
const CustomersFav = () => {
  ...
  return (
    ...
    <h2 className='font-bold text-[2.5rem] p-2 m-auto mb-2 flex justify-center'>Customers Favourite</h2>
      <Slider {...settings}>
